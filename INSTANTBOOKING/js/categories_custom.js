    	...
    	if($('.room-grid').length)
    	{
    		$('.room-grid').isotope({
	            ...
	            getSortData: {
	            	...
	            	{
	            		var priceEle = $(itemElement).find('.room_price').text().replace( '$', '' );
	        ...
	        sortNums.each(function()
	        {
	        	$(this).on('click', function()
	        	{
    				...
    				$('.room-grid').isotope({filter: numFilter });
	        	});
	        });	
	        ...
	        filterButton.on('click', function()
	        {
	        	$('.room-grid').isotope({
		            filter: function()
		            {
			        	...
			        	var itemPrice = $(this).find('.room_price').clone().children().remove().end().text().replace( '$', '' );
